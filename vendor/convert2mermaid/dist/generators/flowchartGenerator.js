import { shapeToNode, shapeToConnector, sanitizeEdgeLabel } from '../utils/labelUtils.js';
import { getStyleStatement, buildEdgeStatement } from '../utils/styleUtils.js';
export const generateFlowchartDiagram = (diagram) => {
    const nodes = [];
    const edges = [];
    const styles = [];
...
//# sourceMappingURL=flowchartGenerator.js.map